...
public class CrossplatformGeneratorCSharp extends AbstractGenerator {
  ...
  private String[][] OpSignPlatArray2D = CrossplatformGeneratorCSharp.new2DString2ArrayOfSize(20, 20);
  ...
  private String[][] classOpSignParamArray2D = CrossplatformGeneratorCSharp.new2DString2ArrayOfSize(20, 20);
    ...
    for (final Entity e : _filter) {
      {
        ...
        this.classOpSignParamArray2D = CrossplatformGeneratorCSharp.new2DString2ArrayOfSize(countOp, 20);
        ...
        if (_equals) {
          ...
          for (final PlatformDecl pe : _filter_2) {
            ...
            if (_equals_1) {
              ...
              this.OpSignPlatArray2D = CrossplatformGeneratorCSharp.new2DString2ArrayOfSize(countOperationPlat, 20);
  ...
  public String treatVariableName(final String variable) {
    boolean _equals = Objects.equal(variable, "img");
    if (_equals) {
      InputOutput.<String>println((" teste variable : " + variable));
      return "Image";
    } else {
      boolean _equals_1 = Objects.equal(variable, "string");
      if (_equals_1) {
  ...
  public String prepareParametersReturn(final Operation op) {
    ...
    if ((((listType == "") || (this.compileType(op.getType()).toString() == "void")) || (this.compileType(op.getType()).toString() == "Void"))) {
      return this.treatVariableName(this.compileType(op.getType()));
    } else {
      return this.treatVariableName(StringExtensions.toFirstUpper(this.compileType(op.getType())));
    }
  }
      ...
      if ((Integer.valueOf(cmd.getArrayAllow()).equals(Integer.valueOf(0)) && (cmd.getConcreteTypes().size() == 0))) {
        {
          ...
          if (_not) {
            _builder.append("   ");
            String _treatVariableName = this.treatVariableName(this._iQualifiedNameProvider.getFullyQualifiedName(cmd.getType()).toString());
            _builder.append(_treatVariableName);
            _builder.append(" ");
            ...
            _builder.append("   ");
            String _treatVariableName_1 = this.treatVariableName(this._iQualifiedNameProvider.getFullyQualifiedName(cmd.getType()).toString());
            _builder.append(_treatVariableName_1);
            _builder.append(" ");
        ...
        if (((!Integer.valueOf(cmd.getArrayAllow()).equals(Integer.valueOf(0))) && (cmd.getConcreteTypes().size() == 0))) {
          ...
          if (_greaterThan) {
            _builder.append("   ");
            String _firstUpper = StringExtensions.toFirstUpper(cmd.getType().getName());
            _builder.append(_firstUpper);
            _builder.append("<");
            ...
            _builder.append("  = new ");
            String _firstUpper_1 = StringExtensions.toFirstUpper(cmd.getType().getName());
    ...
    for (final Integer c : _doubleDotLessThan) {
      {
        ...
        String _treatVariableName = this.treatVariableName(this.compileConcreteTypes(atr.getConcreteTypes().get((c).intValue())));
        String _plus = (comma + _treatVariableName);
  ...
  public String compileConcreteTypes(final Type t) {
    if ((t instanceof Attribute)) {
      return this.treatVariableName(t.getName());
    } else {
  ...
  public String adjustTypeLanguage(final DataType atr) {
    ...
    if (_equals) {
      ...
      if (_equals_1) {
        ...
        boolean _equals_2 = atr.getName().equals("string");
        if (_equals_2) {
          return "String";
        } else {
          return atr.getName();
  ...
  public CharSequence compileMethodCallCmd(final MethodCallCmd cmd) {
    ...
    _builder.append(_obj);
    {
      ...
      for(final Integer h : _doubleDotLessThan) {
        _builder.append(".");
        String _dictionaryCSharp = this.dictionaryCSharp(cmd.getCall().get((h).intValue()));
        _builder.append(_dictionaryCSharp);
      }
    }
    _builder.append("(");
    {
  ...
  public CharSequence compileFatorLog(final FatorLogico fatorLog) {
    StringConcatenation _builder = new StringConcatenation();
    {
      ...
      if (_tripleEquals) {
                      ...
                      if (_tripleNotEquals_6) {
                        ...
                        _builder.append(_vAtr1_3);
                        {
                          ...
                          for(final Integer i_1 : _doubleDotLessThan_1) {
                            _builder.append(".");
                            String _dictionaryCSharp = this.dictionaryCSharp(fatorLog.getExpr2().getVAtr2().get((i_1).intValue()).getName());
                            _builder.append(_dictionaryCSharp);
                          }
                        }
                      } else {
        ...
        String _name_1 = fatorLog.getV().getName();
        _builder.append(_name_1);
      }
    }
    {
   ...
   * ---------------Expressões lógicas--------------
   */
  public String dictionaryCSharp(final String term) {
    boolean _equals = Objects.equal(term, "size");
    if (_equals) {
      return "Count";
    } else {
      boolean _equals_1 = Objects.equal(term, "get");
      if (_equals_1) {
        return "ElementAt";
      } else {
        boolean _equals_2 = Objects.equal(term, "add");
        if (_equals_2) {
          return "Add";
        } else {
          return term;
                ...
                if ((((fator.getVAtr1() != null) && (fator.getMcOperation() == null)) && (fator.getMcGlobal() == null))) {
                  ...
                  _builder.append(_name);
                  {
                    ...
                    for(final Integer y : _doubleDotLessThan) {
                      _builder.append(".");
                      String _dictionaryCSharp = this.dictionaryCSharp(fator.getVAtr2().get((y).intValue()).getName());
                      _builder.append(_dictionaryCSharp);
                      {
                                  ...
                                  if (_tripleNotEquals) {
                                    ...
                                    _builder.append(_vAtr1_1);
                                    {
                                      ...
                                      for(final Integer z : _doubleDotLessThan_1) {
                                        _builder.append(".");
                                        String _dictionaryCSharp_1 = this.dictionaryCSharp(fator.getValue().get((y).intValue()).getVAtr2().get((z).intValue()).getName());
                                        _builder.append(_dictionaryCSharp_1);
                                      }
                                    }
                                  } else {
                                    {
                        ...
                        _builder.newLineIfNotEmpty();
                        {
                          if ((Integer.valueOf(verifPlat).equals(Integer.valueOf(0)) && this.EntityPlatform.equals(this.varController))) {
                            ...
                            _builder.append(_compileType_3);
                            {
                              ...
                              if (_tripleNotEquals_1) {
                                _builder.append("<");
                                String _treatVariableName = this.treatVariableName(contGlobalCall.getGenericTypesDecl().getName());
                                _builder.append(_treatVariableName);
                                _builder.append(">");
                              }
                            }
                            ...
                            _builder.append("(");
                            {
                              ...
                              for(final Integer i_1 : _doubleDotLessThan_4) {
                                String _treatVariableName_1 = this.treatVariableName(this.compileType(contGlobalCall.getParams().get((i_1).intValue()).getType()));
                                String _plus_2 = (_treatVariableName_1 + " ");
  ...
  public CharSequence compile(final Attribute f) {
    StringConcatenation _builder = new StringConcatenation();
    {
      if ((Integer.valueOf(f.getArrayAllow()).equals(Integer.valueOf(0)) && (f.getConcreteTypes().size() == 0))) {
        ...
        String _treatVariableName = this.treatVariableName(this._iQualifiedNameProvider.getFullyQualifiedName(f.getType()).toString());
        _builder.append(_treatVariableName);
        _builder.append(" ");
    ...
    _builder.newLine();
    {
      ...
      if (_equals) {
        _builder.append(" ");
        _builder.append("public ");
        String _treatVariableName_1 = this.treatVariableName(this._iQualifiedNameProvider.getFullyQualifiedName(f.getType()).toString());
        _builder.append(_treatVariableName_1);
        {
        ...
        _builder.append(_firstUpper_1);
        _builder.append("(");
        String _treatVariableName_2 = this.treatVariableName(this._iQualifiedNameProvider.getFullyQualifiedName(f.getType()).toString());
        _builder.append(_treatVariableName_2);
        {
